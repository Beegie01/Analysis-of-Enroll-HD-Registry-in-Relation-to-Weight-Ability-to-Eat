...
<br>As shown above, after training and tuning both the logit & SVM models to predict fifth follow-up BMI classes, the SVM classifier showed better accuracy.
